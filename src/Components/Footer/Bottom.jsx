    ...
    <>
      <div className="bg-black text-white h-[100%] flex justify-between flex-wrap sm:rounded-t-2xl sm:px-3 sm:h-[100%] md:h-[100%] xl:pt-7 xl:h-[40rem]" >
        ...
        <div className="Technologies-col ml-4 xl:w-[250px] xl:h-[554px] my-2 flex flex-col">
          ...
          <Link to="" onClick={Goto} className='text-[15px] mt-2 md:text-[20px] md:gap-1 md:mx-4 md:cursor-pointer md:mt-5 '>Python</Link>
          <Link to="" onClick={Goto} className='text-[15px] mt-2 md:text-[20px] md:gap-1 md:mx-4 md:cursor-pointer md:mt-5 '>Power BI</Link>
          <Link to="" onClick={Goto} className='text-[15px] mt-2 md:text-[20px] md:gap-1 md:mx-4 md:cursor-pointer md:mt-5 '>Tableau</Link>
          <Link to="" onClick={Goto} className='text-[15px] mt-2 md:text-[20px] md:gap-1 md:mx-4 md:cursor-pointer md:mt-5 '>XM- Grace</Link>
          <Link to="" onClick={Goto} className='text-[15px] mt-2 md:text-[20px] md:gap-1 md:mx-4 md:cursor-pointer md:mt-5 '>Machine Learning</Link>
          <Link to="" onClick={Goto} className='text-[15px] mt-2 md:text-[20px] md:gap-1 md:mx-4 md:cursor-pointer md:mt-5 '>Ai Development</Link>
          <Link to="" onClick={Goto} className='text-[15px] mt-2 md:text-[20px] md:gap-1 md:mx-4 md:cursor-pointer md:mt-5 '>ETL</Link>
          <Link to="" onClick={Goto} className='text-[15px] mt-2 md:text-[20px] md:gap-1 md:mx-4 md:cursor-pointer md:mt-5 '>Advance Excel</Link>
          <Link to="" onClick={Goto} className='text-[15px] mt-2 md:text-[20px] md:gap-1 md:mx-4 md:cursor-pointer md:mt-5 '>Front-end</Link>
          <Link to="" onClick={Goto} className='text-[15px] mt-2 md:text-[20px] md:gap-1 md:mx-4 md:cursor-pointer md:mt-5 '>React</Link>
          <Link to="" onClick={Goto} className='text-[15px] mt-2 md:text-[20px] md:gap-1 md:mx-4 md:cursor-pointer md:mt-5 '>Java</Link>
        </div>
