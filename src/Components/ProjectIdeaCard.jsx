        ...
        <>
            <div className="bg-black py-5 text-white xl:h-[500px] xl:flex xl:items-center xl:justify-around">
                <div className="Project-idia-content xl:flex xl:flex-col text-center xl:w-[50%] sm:gap-11 xl:gap-10">
                    ...
                    <p className='my-4 uppercase text-xl rounded-3xl w-[15rem] h-[3rem] sm:w-[15rem] sm:h-[3rem] xl:w-[20rem] xl:h-[4rem] bg-[#101010] flex justify-center items-center mx-auto cursor-pointer hover:bg-red-600'>GET EXPERT ADVICE</p>
                </div>
