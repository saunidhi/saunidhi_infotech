                        ...
                        <div className=' w-[100%] '>
                            ...
                            <div className='bg-white shadow-lg mx-auto w-[90%] sm:w-[100%] p-3 rounded-3xl flex gap-4 my-5 border-2 border-black'>
                                ...
                                <div className='w-auto pl-2'>
                                    <input type="text" className='h-[100%] w-[100%] text-xl border-none' placeholder='Enter Your Name' />
                                </div>
                            </div>
                            <div className='bg-white shadow-lg mx-auto w-[90%] sm:w-[100%] p-3 rounded-3xl flex gap-4 my-5 border-2 border-black'>
                                <div><AiTwotoneMail size={23} /></div>
                                <div className='w-auto pl-2'>
                                    <input type="text" className='h-[100%] w-[100%] text-xl border-none' placeholder='Enter Your Email' />
                                </div>
                            </div>
                            <div className='bg-white shadow-lg mx-auto w-[90%] sm:w-[100%] p-3 rounded-3xl flex gap-4 my-5 border-2 border-black'>
                                <div><FaPhone size={23} /></div>
                                <div className='w-auto pl-2'>
                                    <input type="text" className='h-[100%] w-[100%] text-xl border-none' placeholder='Enter Your Phone' />
                                </div>
                            </div>
                            <div className='bg-white shadow-lg mx-auto w-[90%] sm:w-[100%] p-3 rounded-3xl flex gap-4 my-5 border-2 border-black'>
                                <div><FaLock size={23} /></div>
                                <div className='w-auto pl-2'>
                                    <input type="password" className='h-[100%] w-[100%] text-xl border-0' placeholder='Create A Password' />
                                </div>
                            </div>

                            <div className='bg-blue-800 cursor-pointer shadow-md mt-8 mx-auto w-[90%] sm:w-[100%] text-white p-3 rounded-full flex justify-center border-2 border-[#090303] text-[23px]' style={{ FontFamily: "Readex Pro", FontStyle: "normal", FontWeight: "400" }}>Sign up</div>
                        </div>
