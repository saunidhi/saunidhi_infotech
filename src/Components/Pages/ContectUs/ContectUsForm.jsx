  ...
  return (
    <>
      <div className="flex flex-col bg-[#EFEFF0] my-5 p-3 ">
        ...
        <span className='uppercase text-2xl py-3 md:mx-8'>Contect Us</span>
        ...
        <span className=' md:mx-8 '>* is required for submission</span>
        ...
        <p className='pt-3'>By clicking “Submit” you agree that Saunidhi InfoTech will process your personal data provided in the above form for communicating with you as our potential or actual customer or a client as described in our.</p>
