                    ...
                    <div className='flex flex-col items-center mx-auto gap-6' >
                        ...
                        <div className=' w-[100%] '>
                            ...
                            <div className='bg-white shadow-lg mx-auto w-[90%] sm:w-[100%] p-3 rounded-3xl flex gap-4 my-5 border-2 border-black'>
                                ...
                                <div className='w-auto pl-2'>
                                    <input type="text" className='h-[100%] w-[100%] text-xl border-none' placeholder='Enter Email or Phone' />
                                </div>
                            </div>
                            <div className='bg-white shadow-lg mx-auto w-[90%] sm:w-[100%] p-3 rounded-3xl flex gap-4 my-5 border-2 border-black'>
                                <div><FaLock size={23} /></div>
                                <div className='w-auto pl-2'>
                                    <input type="password" style={{}} className='h-[100%] w-[100%] text-xl border-none bg-transparent' placeholder='Enter Password' />
                                </div>
                            </div>

                            <div className='bg-blue-800 cursor-pointer shadow-md mt-8 mx-auto w-[90%] sm:w-[100%] text-white p-3 rounded-full flex justify-center border-2 border-[#090303] text-[23px]' style={{ FontFamily: "Readex Pro", FontStyle: "normal", FontWeight: "400" }}>Login</div>
                        </div>
                        ...
                        <div className='flex flex-col'>
                            <div className='flex justify-between'>
                                ...
                                <Link to="#" className='text-lg w-fit cursor-pointer capitalize text-[#000] hover:text-blue-600 ' style={{ FontFamily: " Red Rose", FontWeight: "400" }}>forget password</Link>
                            </div>
